...
<body>
    ...
    <main>
        <h2 style="margin-top:20px">Biaya Material Penyusun</h2>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($bb as $row) : ?>
                    <tr>
                        ...
                        <td class="service">Rp <?= number_format($row['harga_beli'], 0), '', '.'; ?>,-</td>
                        <td class="total">Rp <?= number_format($row['totalharga'], 0, '', '.'); ?>,-</td>
                    </tr>
                <?php endforeach; ?>
                <tr>
