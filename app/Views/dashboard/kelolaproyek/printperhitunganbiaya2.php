...
<body>
    <section class="header">
        ...
        <div style="margin-left:100px;">
            <h1>PT ADIKA JAYA ENGINEERING</h1>
            <div class="bungkussub">
                <div class="subjudul">Office : Jl. Gemah Kumala No 16 Pedurungan Semarang 50191</div>
                <div class="subjudul">Workshop : Jl. Kyai Selan RT 06 RW 03 Ds. Penyangkringan <br> Karangmulyo Kec. Pegandon Kab. Kendal 51357</div>
                <div>No Telp : +62 821-1458-7645 , Email: <a>adikajayaengineering@gmail.com</a></div>
            </div>
        </div>
    </section>
    <div class="baris"></div>
