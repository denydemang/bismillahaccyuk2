        ...
        <tbody>
            ...
            <?php foreach ($tenaker as $row) : ?>
                <tr>
                    ...
                    <td>
                        <button data-id="<?= $row['id_pbtenakerr']; ?>" data-idtenaker="<?= $row['id_pbtenaker']; ?>" data-namaproyek="<?= $row['namaproyek']; ?>" class="btn btn-sm btn-primary edittk">Edit</button>
                        <button data-id="<?= $row['id_pbtenakerr']; ?>" data-idtenaker="<?= $row['id_pbtenaker']; ?>" data-namaproyek="<?= $row['namaproyek']; ?>" class="btn btn-sm btn-warning hapustk">Hapus</button>
                    </td>
                </tr>
            <?php endforeach; ?>
