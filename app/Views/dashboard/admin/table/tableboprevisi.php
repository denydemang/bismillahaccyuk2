        ...
        <tbody>
            ...
            <?php foreach ($bop as $row) : ?>
                <tr>
                    ...
                    <td>
                        <button data-id="<?= $row['id_pbopr']; ?>" data-namatrans="<?= $row['namatrans']; ?>" data-namaproyek="<?= $row['namaproyek']; ?>" data-idbiaya="<?= $row['id_pbop']; ?>" class="btn btn-sm btn-primary editbop">Edit</button>
