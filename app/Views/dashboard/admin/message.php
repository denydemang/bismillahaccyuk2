            ...
            <div class="col col-lg-6">
                <div class="card direct-chat direct-chat-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php foreach ($massage2 as $msg2) : ?>
                            ...
                            '<div class="direct-chat-msg right">
                                <div class="direct-chat-infos clearfix">
                                    <span class="direct-chat-name float-right">klien</span></div>
                                <div class="direct-chat-text">'
                                    .$msg2['pesan'].'                                
                                </div>
                            </div>'
                    ...
                    <div class="card-footer">
                        ...
                        <!-- <form action="<?//= base_url('/DashboardAdmin/store/'); ?>" method="post"> -->
                        <!-- <form action="<?//= base_url('/DashboardAdmin/message/'.$kl->id_client); ?>" method="post"> -->
                        <?php //endforeach; ?>    
                            <div class="input-group">
                                <?php foreach ($klik as $kl) : ?>
                                <input type="hidden" id="id_admin" name="id_admin" value="<?php echo $kl->id_admin;?>" class="form-control">
                                <input type="hidden" id="id_client" name="id_client" value="<?php echo $kl->id_client;?>" class="form-control">
...
//     console.log('halo');
    ...
    //             str +=
    //             (data[z].id_admin === '0') ?
    //             '<div class="direct-chat-msg"><div class="direct-chat-infos clearfix"><span class="direct-chat-name float-left">Admin</span><span class="direct-chat-timestamp float-right">23 Jan 2:00 pm</span></div><img class="direct-chat-img" src="<?= base_url('assetslte') ?>/dist/img/user1-128x128.jpg" alt="message user image"><div class="direct-chat-text">'+$data[z].pesan+'</div></div>':
    //             '<div class="direct-chat-msg right"><div class="direct-chat-infos clearfix"><span class="direct-chat-name float-right">Klien</span><span class="direct-chat-timestamp float-left">23 Jan 2:05 pm</span></div><img class="direct-chat-img" src="<?= base_url('assetslte') ?>/dist/img/user3-128x128.jpg" alt="message user image"><div id="pesan" name="pesan" class="direct-chat-text">'+$data[z].pesan+'</div></div>';
    //         }
    //         $('#didpesan').html(str);
    //     }
    //     function hapuschat(){
