...
<body>
    ...
    <main>
        ...
        <?php if (sizeof($bbrevisi) != 0) : ?>
            <h3 style="margin-top:20px">Biaya Material Penyusun Yang Direvisi</h3>
            <table>
                <thead>
                    <tr>
                        <th class="service">Nama Material</th>
                ...
                <tbody>
                    <?php foreach ($bbrevisi as $row) : ?>
                        <tr>
                            <td class="service"><?= $row['namampr']; ?></td>
                            <td class="service"><?= $row['satuanmpr']; ?></td>
                            <td class="service"><?= $row['jumlahmpr']; ?></td>
                            <td class="service">Rp <?= number_format($row['hargampr'], 0, '', '.'); ?>,-</td>
                            <td class="total">Rp <?= number_format($row['totalmpr'], 0, '', '.'); ?>,-</td>
                        </tr>
                    <?php endforeach; ?>
                    <tr>
                        <td colspan="4">SUBTOTAL Material</td>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php endforeach; ?>
                <?php if (sizeof($tkrevisi) == 0) : ?>
                    <tr>
                        <td colspan="4">SUBTOTAL Tenaker</td>
        ...
        <?php if (sizeof($tkrevisi) != 0) : ?>
            <h3 style="margin-top:40px">Biaya Tenaga Kerja Revisi</h3>
            <table>
                <thead>
                    <tr>
                        <th class="service">JobDesk</th>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="total"><?= $row['tot_biaya']; ?></td>
                </tr>
                <tr>
