            ...
            <tbody>
                <?php if (empty($tk)) : ?>
                    <?php foreach ($tk as $row) : ?>
                        <tr>
                            <td class="service" style="text-align:center">-</td>
                            <td class="service" style="text-align:center">-</td>
                            <td class="service" style="text-align:center">-</td>
                            <td class="service" style="text-align:center">-</td>
                            <td class="total" style="text-align:center">-</td>
                ...
                <?php else : ?>
                    <?php foreach ($tk as $row) : ?>
                        <tr>
                            ...
                            <td class="service" style="text-align:center">Rp <?= number_format($row['gaji'], 0, '', '.'); ?></td>
                            <td class="service" style="text-align:center"><?= $row['total_pekerja']; ?></td>
                            <td class="total" style="text-align:center">Rp <?= number_format($row['total_gaji'], 0, '', '.'); ?></td>
                        </tr>
                    <?php endforeach; ?>
                    <tr>
                        <td colspan="4">SUBTOTAL</td>
                ...
                <?php else : ?>
                    <?php foreach ($bop as $row) : ?>
                        <tr>
                            ...
                            <td class="desc" style="text-align:center"><?= $row['quantity']; ?></td>
                            <td class="desc" style="text-align:center"><?= $row['satuan']; ?></td>
                            <td class="desc" style="text-align:center">Rp <?= number_format($row['harga']); ?>,-</td>
                            <td class="total" style="text-align:center">Rp <?= number_format($row['tot_biaya'], 0, '', '.'); ?>,-</td>
                        </tr>
                    <?php endforeach; ?>
                    <tr>
